"""
Django settings for qnode01_app project.
...
WAGTAILIMAGES_MAX_UPLOAD_SIZE = 50 * 5024 * 5024  # i.e. 20MB
...
WSGI_APPLICATION = 'qnode01_app.wsgi.application'
